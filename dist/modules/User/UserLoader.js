...
var UsersRepository = typeorm_1.getRepository(UserModel_1.default);
function saveUser(_, parameters) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, UsersRepository.create(user)];
                case 1:
                    databaseUser = _a.sent();
                    return [2 /*return*/, databaseUser];
            }
        });
    });
}
